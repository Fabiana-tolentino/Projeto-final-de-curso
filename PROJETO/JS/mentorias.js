const renderMentorias = (mentorias) => { // recebe os mentores
...
const pagMentor = () =>{ 
window.location = "/Mentor/html/mentores.html"
}
getMentorias()
